...
try {
  if ($countResult = $conn->query('SELECT COUNT(*) AS total FROM user_master')) {
  ...
  if ($activeResult = $conn->query('SELECT COUNT(*) AS active FROM user_master WHERE IsActive = 1')) {
  ...
  if ($typeResult = $conn->query('SELECT COUNT(*) AS total FROM user_type')) {
    if ($row = $typeResult->fetch_assoc()) {
      $userTypeCount = (int)$row['total'];
    }
    $typeResult->free();
  }
...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Admin Dashboard - Rewarity</title>
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						...
						<div class="card bg-warning invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"><?php echo number_format($totalUsers); ?></h2>
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						...
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"><?php echo number_format($activeUsers); ?></h2>
									<span class="text-white fs-18">Active Users</span>
								</div>
							</div>
						</div>
						</a>
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						...
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"><?php echo number_format($inactiveUsers); ?></h2>
									<span class="text-white fs-18">Inactive Users</span>
								</div>
							</div>
						</div>
						</a>
					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						...
						<div class="card bg-secondary invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"><?php echo number_format($userTypeCount); ?></h2>
									<span class="text-white fs-18">User Roles</span>
								</div>
							</div>
						</div>
						</a>
